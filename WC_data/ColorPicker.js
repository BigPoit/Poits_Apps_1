document.addEventListener("DOMContentLoaded", function () {
    ...
    const paletteOptions = [
        { value: "cloud", label: "wolken" },
        { value: "heat", label: "hitte" },
        { value: "ocean", label: "oceaan" },
        { value: "forest", label: "bos" },
        { value: "rainbow", label: "regenboog" },
        { value: "rainbowstripe", label: "regenboog strepen" },
        { value: "party", label: "feestje" },
        { value: "lava", label: "lava" },
        { value: "quagga", label: "quagga" },
        { value: "sunrise", label: "sunrise" },
        { value: "bhw2_49", label: "bhw2_49" },
        { value: "hate_thursday", label: "i hate thursday" },
        { value: "morn_coffee", label: "morning coffee" },
        { value: "black_white", label: "zwart wit" },
        { value: "aurora_green", label: "aurora groen" },
        { value: "aurora_purple", label: "aurora purple" }
    ];
